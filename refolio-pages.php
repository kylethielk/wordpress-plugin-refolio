...
class Refolio_Pages
{
        ...
        <table class="widefat fixed refolio-table" style="margin-top: 15px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo $refolio->build_admin_modify_page_url() . '&refolio_id=' . $portfolio->id; ?>">Edit</a>
                        | <a
                            href="<?php echo $refolio->build_admin_review_page_url() . '&refolio_del=' . $portfolio->id; ?>"
    ...
    <div class="wrap">
        ...
        <div id="refolio_errors" style="display: none" class="refolio-errors">There are errors, please correct them and
            try
            again.
        </div>
